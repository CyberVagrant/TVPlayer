...
import cn.codedoge.tvplayer.widget.media.IRenderView;
...
public class PlayerManager {
    ...
    public PlayerManager(final Activity activity) {
        ...
        mCenterText = activity.findViewById(R.id.control_text);
        mCenterView = activity.findViewById(R.id.center_text_root);
